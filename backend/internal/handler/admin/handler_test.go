...
func TestHandler_GetDashboard(t *testing.T) {
	...
	mockRepo.Create(context.Background(), article1)
	mockRepo.Create(context.Background(), article2)
	mockRepo.Create(context.Background(), article3)
...
func TestHandler_GetAllArticles(t *testing.T) {
	...
	article1 := createTestArticle( "Article 1", "Content 1", "Author 1", true)
	article2 := createTestArticle( "Article 2", "Content 2", "Author 2", false)
	mockRepo.Create(context.Background(), article1)
	mockRepo.Create(context.Background(), article2)
...
func TestHandler_UpdateArticle(t *testing.T) {
	...
	article := createTestArticle( "Original Title", "Original Content", "Original Author", false)
	mockRepo.Create(context.Background(), article)
...
func TestHandler_DeleteArticle(t *testing.T) {
	...
	article := createTestArticle( "To Delete", "Content", "Author", false)
	mockRepo.Create(context.Background(), article)
...
func TestHandler_GetArticle(t *testing.T) {
	...
	article := createTestArticle( "Test Article", "Test Content", "Test Author", true)
	mockRepo.Create(context.Background(), article)
